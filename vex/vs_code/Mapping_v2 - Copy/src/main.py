...
def controller_1buttonL1_pressed_callback_0():
    ...
    TopMotor.spin(REVERSE)
    Intake_Motor.spin(FORWARD)
    if Recording==1 or Recording==2:
        #Intake and Top Motor position recording reset for Aton
        Intake_Motor.set_position(0, DEGREES)
    ...
    if Recording==1:
        ...
        brain.sdcard.appendfile("Left_Aton.txt", bytearray(", Intake_Motor.spin_for(FORWARD, %f, DEGREES, wait=False)"%(Intake_Motor.position(DEGREES)), "utf-8"))
        brain.sdcard.appendfile("Left_Aton.txt", bytearray(", TopMotor.spin_for(FORWARD, %f, DEGREES, wait=False)"%(TopMotor.position(DEGREES)), "utf-8"))
        print("Recorded Intake Motor Degrees: ", str(Intake_Motor.position(DEGREES)))
        print("Recorded Top Motor Degrees: ", str(TopMotor.position(DEGREES)))
    elif Recording==2:
        #Intake and Top Motor position recording for Right Aton
        brain.sdcard.appendfile("Right_Aton.txt", bytearray(", Intake_Motor.spin_for(FORWARD, %f, DEGREES, wait=False)"%(Intake_Motor.position(DEGREES)), "utf-8"))
        brain.sdcard.appendfile("Right_Aton.txt", bytearray(", TopMotor.spin_for(FORWARD, %f, DEGREES, wait=False)"%(TopMotor.position(DEGREES)), "utf-8"))
        print("Recorded Intake Motor Degrees: ", str(Intake_Motor.position(DEGREES)))
        print("Recorded Top Motor Degrees: ", str(TopMotor.position(DEGREES)))
...
def controller_1buttonR1_pressed_callback_0():
    ...
    Intake_Motor.spin(FORWARD)
    if Recording==1 or Recording==2:
        #Intake Motor position recording reset for Aton
        Intake_Motor.set_position(0, DEGREES)
...
def controller_1buttonA_pressed_callback_0():
    ...
    if Recording==0:
        controller_1.screen.clear_row(3)
        controller_1.screen.set_cursor(3,1)
        controller_1.screen.print("Are you sure? (Record left Aton) A/B")
        controller_1.buttonA.pressed(Yes_left)
        while Recording==0:
            wait(5,MSEC)
...
def ondriver_drivercontrol_0():
    ...
    if Recording==1 or Recording==2 or Recording==0:
        ...
        if Recording==1:
            ...
            brain.sdcard.savefile("Left_Aton.txt",  bytearray("set_drivetrain_volosity_v(%f)"%(Volosity_Aton), "utf-8")) #type: ignore
            ...
            while Recording==1:
                ...
                if controller_1.axis2.position() != 0 and controller_1.axis3.position() != 0:
                    while controller_1.axis2.position() != 0 and controller_1.axis3.position() != 0:
                        ...
                        if controller_1.axis2.position() == 0 or controller_1.axis3.position() == 0:
                            break
                    brain.sdcard.appendfile("Left_Aton.txt", bytearray(", Drive_Forward_MM_mm(%f)" %((Right1.position(DEGREES)+Left1.position(DEGREES))/2), "utf-8")) #type: ignore
                ...
                if controller_1.axis2.position() < 0 and controller_1.axis3.position() > 0:
                    while controller_1.axis2.position() < 0 and controller_1.axis3.position() > 0:
                        ...
                        if controller_1.axis2.position() == 0 or controller_1.axis3.position() == 0:
                            break
                    brain.sdcard.appendfile("Left_Aton.txt", bytearray(", Turn_Degrees_Degrees(%f)" %(inertial_for_auton.rotation(DEGREES)), "utf-8")) #type: ignore
        ...
        # Right Aton Recording Code    
            ...
            brain.sdcard.savefile("Right_Aton.txt", bytearray("set_drivetrain_volosity_v(%f)"%(Volosity_Aton), "utf-8")) #type: ignore
            ...
            while Recording==2:
                ...
                if controller_1.axis2.position() > 0 and controller_1.axis3.position() > 0:
                    while controller_1.axis2.position() > 0 and controller_1.axis3.position() > 0:
                        ...
                        if controller_1.axis2.position() == 0 or controller_1.axis3.position() == 0:
                            break
                    brain.sdcard.appendfile("Right_Aton.txt", bytearray(", Drive_Forward_MM_mm(%f)" %((Right1.position(DEGREES)+Left1.position(DEGREES))/2), "utf-8")) #type: ignore
                    print("Recorded Drive F: ", str((Right1.position(DEGREES)+Left1.position(DEGREES))/2))
                    Right1.set_position(0, DEGREES)
                    Left1.set_position(0, DEGREES)
                ...
                if controller_1.axis2.position() < 0 and controller_1.axis3.position() > 0:
                    while controller_1.axis2.position() < 0 and controller_1.axis3.position() > 0:
                        ...
                        if controller_1.axis2.position() == 0 or controller_1.axis3.position() == 0:
                            break
                    brain.sdcard.appendfile("Right_Aton.txt", bytearray(", Turn_Degrees_Degrees(%f)" %(inertial_for_auton.rotation(DEGREES)), "utf-8")) #type: ignore
                    print("Recorded Turn R: ", str(inertial_for_auton.rotation(DEGREES)))
                    Right1.set_position(0, DEGREES)
                    Left1.set_position(0, DEGREES)
