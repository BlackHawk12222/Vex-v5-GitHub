...
class Logging:
    ...
    def motor(self, motor):
        ...
        while True:
            ...
            if motor.power(PowerUnits.WATT)>40 and (self.power_monitoring==0 or self.power_monitoring==2):
                log.add("EM1", "Power: %s"%(motor.power(PowerUnits.WATT)))
                self.power_monitoring=1
            elif motor.power(PowerUnits.WATT)>30 and (self.power_monitoring==0 or self.power_monitoring==1):
                log.add("WM1", "Power: %s"%(motor.power(PowerUnits.WATT)))
                self.power_monitoring=2
    ...
    def Controller_1(self):
        ...
        while True:
            ...
            if controller_1.buttonA.pressing() and self.button_pressing==0:
                log.record.controller_1_button("A")
                self.button_pressing=1
            if controller_1.buttonB.pressing() and self.button_pressing==0:
                log.record.controller_1_button("B")
                self.button_pressing=1
            if controller_1.buttonX.pressing() and self.button_pressing==0:
                log.record.controller_1_button("X")
                self.button_pressing=1
            if controller_1.buttonY.pressing() and self.button_pressing==0:
                log.record.controller_1_button("Y")
                self.button_pressing=1
            if controller_1.buttonUp.pressing() and self.button_pressing==0:
                log.record.controller_1_button("UP")
                self.button_pressing=1
            if controller_1.buttonDown.pressing() and self.button_pressing==0:
                log.record.controller_1_button("DOWN")
                self.button_pressing=1
            if controller_1.buttonLeft.pressing() and self.button_pressing==0:
                log.record.controller_1_button("LEFT")
                self.button_pressing=1
            if controller_1.buttonRight.pressing() and self.button_pressing==0:
                log.record.controller_1_button("RIGHT")
                self.button_pressing=1
            if controller_1.buttonL1.pressing() and self.button_pressing==0:
                log.record.controller_1_button("L1")
                self.button_pressing=1
            if controller_1.buttonL2.pressing() and self.button_pressing==0:
                log.record.controller_1_button("L2")
                self.button_pressing=1
            if controller_1.buttonR1.pressing() and self.button_pressing==0:
                log.record.controller_1_button("R1")
                self.button_pressing=1
            if controller_1.buttonR2.pressing() and self.button_pressing==0:
                log.record.controller_1_button("R2")
                self.button_pressing=1
            wait(50, MSEC)
            if not(controller_1.buttonA.pressing() and controller_1.buttonB.pressing() and controller_1.buttonX.pressing() and controller_1.buttonY.pressing() and controller_1.buttonUp.pressing() and controller_1.buttonDown.pressing() and controller_1.buttonLeft.pressing() and controller_1.buttonRight.pressing() and controller_1.buttonL1.pressing() and controller_1.buttonL2.pressing() and controller_1.buttonR1.pressing() and controller_1.buttonR2.pressing()):
                self.button_pressing=0
    ...
    def Controller_2(self):
        ...
        while True:
            ...
            if controller_2.buttonA.pressing() and self.button_pressing==0:
                log.record.controller_2_button("A")
                self.button_pressing=1
            if controller_2.buttonB.pressing() and self.button_pressing==0:
                log.record.controller_2_button("B")
                self.button_pressing=1
            if controller_2.buttonX.pressing() and self.button_pressing==0:
                log.record.controller_2_button("X")
                self.button_pressing=1
            if controller_2.buttonY.pressing() and self.button_pressing==0:
                log.record.controller_2_button("Y")
                self.button_pressing=1
            if controller_2.buttonUp.pressing() and self.button_pressing==0:
                log.record.controller_2_button("UP")
                self.button_pressing=1
            if controller_2.buttonDown.pressing() and self.button_pressing==0:
                log.record.controller_2_button("DOWN")
                self.button_pressing=1
            if controller_2.buttonLeft.pressing() and self.button_pressing==0:
                log.record.controller_2_button("LEFT")
                self.button_pressing=1
            if controller_2.buttonRight.pressing() and self.button_pressing==0:
                log.record.controller_2_button("RIGHT")
                self.button_pressing=1
            if controller_2.buttonL1.pressing() and self.button_pressing==0:
                log.record.controller_2_button("L1")
                self.button_pressing=1
            if controller_2.buttonL2.pressing() and self.button_pressing==0:
                log.record.controller_2_button("L2")
                self.button_pressing=1
            if controller_2.buttonR1.pressing() and self.button_pressing==0:
                log.record.controller_2_button("R1")
                self.button_pressing=1
            if controller_2.buttonR2.pressing() and self.button_pressing==0:
