...
def Curved_move(Left_degrees,Right_degrees, Left_velosity_Curved_move, Right_velosity_Curved_move):
    global my_event, Consle_output, Accuracy, Front_Down, Degees_to_mm, Speed_To_Volts, Push, degrees_to_Degrees, Degrees_to_mm, inertial_mm, degrees_of_rotation, degrees_2, Degrees_to_mm_2, volosity_history, color_select, Aton_select, screen_precision, console_precision, controller_1_precision
    Right1.set_velocity(Right_velosity_Curved_move, PERCENT)
    Right2.set_velocity(Right_velosity_Curved_move, PERCENT)
    Right3.set_velocity(Right_velosity_Curved_move, PERCENT)
    Left1.set_velocity(Left_velosity_Curved_move, PERCENT)
    Left2.set_velocity(Left_velosity_Curved_move, PERCENT)
    Left3.set_velocity(Left_velosity_Curved_move, PERCENT)
...
def when_started1():
    global my_event, Consle_output, color_select, Aton_select, screen_options
...
def controller_1buttonA_pressed_callback_0():
    ...
    if Recording==0:
        controller_1.screen.clear_row(3)
        controller_1.screen.set_cursor(3,1)
        controller_1.screen.print("Record left Aton? A/B")
        ...
        if Recording==1:
            ...
            while Recording==1:
                ...
                if controller_1.axis2.position() != 0 and controller_1.axis3.position() != 0:
                    ...
                    brain.sdcard.appendfile("Left_Aton.txt", bytearray(", Curved_move(%f, %f)" %(Right1.position(DEGREES), Left1.position(DEGREES)), "utf-8"))
                    print("Recorded Drive F: ", Right1.position(DEGREES), Left1.position(DEGREES), Left_Velosity, Right_Velosity)
                    Right1.set_position(0, DEGREES)
                    Left1.set_position(0, DEGREES)
                    Left_Velosity.clear()
                    Right_Velosity.clear()
                ...
                if controller_1.axis3.position() != 0:
                    ...
                    brain.sdcard.appendfile("Right_Aton.txt", bytearray(", set_drivetrain_volosity_v(%f)"%(Right_Velosity),"utf-8"))
                ...
                if controller_1.axis2.position() != 0:
                    ...
                    brain.sdcard.appendfile("Left_Aton.txt", bytearray(", set_drivetrain_volosity_v(%f)"%(Left_Velosity),"utf-8"))
...
def Dinostics():
    global my_event, Consle_output, screen_options
    B_print=brain.screen.print
